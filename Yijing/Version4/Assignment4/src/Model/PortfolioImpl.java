...
public class PortfolioImpl implements Portfolio {
  ...
  @Override
  public Boolean saveDateToFile(String fileName) throws IllegalArgumentException {
    // Check file name first; we cannot take empty string.
    if (fileName.isEmpty()) {
    ...
    StringBuilder sb = new StringBuilder().append(this.portfolioName).append(",");

...
public class AlphaVantageImplTest {
  ...
  /**
   * getURL() Test: if we input invalid stock symbol, it will throw IllegalArgumentException.
   */
  @Test
  public void getURLFailTest() {
    try {
      api.checkTikerAvailable("yijing");
    } catch (Exception exception) {
      assertEquals("No data found for yijing!", exception.getMessage());
    }
  }

...
public class ModelImplTest {
  ...
  /**
   * readDateFromAll() Test: read portfolio information from all files. If it works, it will return
   * correct portfolio information.
   */
  @Test
  public void readDateFromAllTest() {
    this.model.readDataFromALL();
    assertEquals("Portfolio name: test1.csv\n" +
                    "Ticker name: GOOG, Buy price per stock: 99.3, Stock quantity: 100, "
                    + "Purchase date: 2022-10-03\n"
                    + "Ticker name: IBM, Buy price per stock: 121.51, Stock quantity: 100, "
                    + "Purchase date: 2022-10-03\n\n",
            this.model.toString());
  }
